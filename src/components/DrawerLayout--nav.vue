<template>
  <div>
    <v-toolbar tabs style="z-index: 2;">
      ...
      <v-tabs slot="extension" v-model="tabs" fixed-tabs color="transparent" grow>
        <v-tabs-slider></v-tabs-slider>
        <v-tab
          style="font-family: AvenirNext, Avenir, Helvetica, Arial, sans-serif;"
          ripple
